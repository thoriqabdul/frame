        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="media doc_features_item_one wow fadeInLeft" data-wow-delay="0.2s">
                    <img src="{{asset('client/img/home_one/Lamp_idea.png')}}" alt="">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="media doc_features_item_one wow fadeInLeft" data-wow-delay="0.5s">
                    <img src="{{asset('client/img/home_one/chat.png')}}" alt="">
                    <div class="media-body">
                        <a href="#">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="media doc_features_item_one wow fadeInLeft" data-wow-delay="0.7s">
                    <img src="{{asset('client/img/home_one/Duplicate.png')}}" alt="">
                    <div class="media-body">
                        <a href="#">
                            <h3>Documentation</h3>
                        </a>
                    ...
                    <div class="col-lg-4">
                        <div class="documentation_text">
                            <div class="round wow fadeInUp">
                                <img src="{{asset('client/img/home_one/icon/file1.png')}}" alt="">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/folder.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
                            ...
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/envelope.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
                            ...
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/smartphone.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
                                            <h5>Mobile Apps</h5>
                            ...
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/management.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
                            ...
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/newspaper.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
                                            <h5>Productivity</h5>
                            ...
                            <div class="col-sm-6">
                                <div class="media documentation_item wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="icon">
                                        <img src="{{asset('client/img/home_one/icon/android.png')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <a href="#">
...
<section class="doc_feedback_area parallaxie sec_pad" data-background="{{asset('client/img/bg.jpg')}}" style="background: url({{asset('client/img/home_one/feedback_bg.jpg')}}) no-repeat scroll;">
