            ...
            <ul class="navbar-nav menu ml-auto">
                <li class="nav-item dropdown submenu active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item"><a href="index-2.html" class="nav-link">Light Template</a></li>
                        <li class="nav-item"><a href="index-3.html" class="nav-link">Help Desk</a></li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown_menu_two">
                        <li class="nav-item">
                            <a href="doc-archive.html" class="nav-link">
                                <img src="{{asset('client/img/tick.png')}}" alt="">
                                <div class="text">
                                    <h5>Docly</h5>
                        ...
                        <li class="nav-item">
                            <a href="doclist.html" class="nav-link">
                                <img src="{{asset('client/img/sheet.png')}}" alt="">
                                <div class="text">
                                    <h5>docall</h5>
                        ...
                        <li class="nav-item">
                            <a href="index.html" class="nav-link">
                                <img src="{{asset('client/img/shopping-bag.png')}}" alt="">
                                <div class="text">
                                    <h5>Docenvato</h5>
                        ...
                        <li class="nav-item">
                            <a href="index.html" class="nav-link">
                                <img src="{{asset('client/img/gear.png')}}" alt="">
                                <div class="text">
                                    <h5>Tools</h5>
